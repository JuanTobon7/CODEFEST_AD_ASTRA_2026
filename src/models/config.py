...
class Settings(BaseSettings):
    ...
    # Repositorio de chunks: el JSON es el artefacto portable por defecto y la
    # fuente de verdad de los fragmentos (metadata.json). Se puede conservar
    # MongoDB con CHUNK_REPOSITORY=mongo.
